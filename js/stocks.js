...
// ============================================================================
// Multi-line chart showing stock prices for AAPL, GOOG, AMZN, IBM, and MSFT
// Refer to demo.js Section 5 for the pattern used here
// ============================================================================
...
// DATA LOADING
// ============================================================================
// Load CSV files for all stocks in parallel
...
stocks.forEach(stock => {
    stock.values.forEach(d => {
        ...
        // Convert d.Close from string to number
        d.Close = +d.Close;

        // Convert these additional fields to numbers
        d.Open = +d.Open;
        d.High = +d.High;
        d.Low = +d.Low;
        d.Volume = +d.Volume;
    ...
    // Sort stock.values by date (oldest to newest)
...
svg.append('text')
    ...
    .text('Stock Prices Over Time (AAPL, GOOG, AMZN, IBM, MSFT)');
